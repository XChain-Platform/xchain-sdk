...
const { decodeActionStringFromPsbt, extractEnvelopeActionString } = require('../cosigner/psbt_action_decode.js');
const { verifyCarrierScripts } = require('./verify_carrier_scripts.js');
