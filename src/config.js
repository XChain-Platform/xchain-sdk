...
// The field lists getConfig returns. Each call hands out its own copies, so
// a caller that edits the lists it was given never changes the next caller's.
