 ...
 * The helper API is reachable from browser surfaces (the wallet shells and any
 * hosted tool driving the SDK), so an allowlist is the real shape of the setting
 * and a single string never was.
 *
