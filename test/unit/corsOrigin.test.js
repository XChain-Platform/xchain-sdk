...
// The browser surfaces that actually reach the helper API cross-origin: the
// wallet shells (iOS falls to Capacitor's default `capacitor://localhost`,
// Android sends `https://localhost`) and the hosted explorer.
