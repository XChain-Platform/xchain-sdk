...
module.exports = {
    WalletUtils: [
        ['resolveMaxFeeRate', false, true, true, 'function', 1],
    ...
    Validator: [
        ...
        ['validateBatchFields', false, true, true, 'function', 1],
        ['validateBetDetailsShape', false, true, true, 'function', 3],
        ['validateBetFields', false, true, true, 'function', 1],
        ...
        ['validateFieldValue', false, true, true, 'function', 4],
